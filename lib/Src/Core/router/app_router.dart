    ...
    routes: [
      ...
      ShellRoute(builder: (_, __, child) => AppShell(mode: ShellMode.client, child: child), routes: [
        ...
        GoRoute(path: RoutePaths.clientPlans, builder: (_, __) => const ResourceTabsPage(tabs: [
          ResourceTabDefinition(label: 'Planos', title: 'Planos de fidelidade', subtitle: 'Consulte os benefícios disponíveis para sua rotina.', endpoint: Endpoints.plans),
          ResourceTabDefinition(label: 'Meu plano', title: 'Meu plano de fidelidade', subtitle: 'Consulte status e benefícios do seu plano.', endpoint: Endpoints.subscriptions),
        ])),
