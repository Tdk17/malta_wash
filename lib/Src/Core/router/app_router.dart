...
class AppRouter {
  ...
  late final GoRouter router = GoRouter(
    ...
    routes: [
      ...
      ShellRoute(
        builder: (_, __, child) => AppShell(mode: ShellMode.client, child: child),
        routes: [
          ...
          GoRoute(
            path: RoutePaths.clientAppointments,
            builder: (_, __) => const ResourceListPage(
              title: 'Meus agendamentos',
              subtitle: 'Acompanhe seus próximos agendamentos e o histórico de lavagens.',
          ...
          GoRoute(
            ...
            builder: (_, __) => const ResourceTabsPage(tabs: [
              ResourceTabDefinition(
                ...
                subtitle: 'Escolha o plano que combina com a sua rotina.',
                endpoint: Endpoints.plans,
              ),
              ResourceTabDefinition(
                label: 'Minha assinatura',
                title: 'Minha assinatura',
                subtitle: 'Consulte status e benefícios da sua assinatura.',
          ...
          GoRoute(
            ...
            builder: (_, __) => const ResourceDetailPage(
              title: 'Perfil',
              subtitle: 'Seus dados pessoais e preferências.',
      ...
      ShellRoute(
        builder: (_, __, child) => AppShell(mode: ShellMode.admin, child: child),
        routes: [
          ...
          GoRoute(
            ...
            builder: (_, __) => const AdminCommercialConfigPage(mode: CommercialConfigMode.plans),
          ),
          GoRoute(
            path: RoutePaths.adminLoyalty,
            builder: (_, __) => const AdminCommercialConfigPage(mode: CommercialConfigMode.loyalty),
          ),
          GoRoute(
            path: RoutePaths.adminSettings,
            builder: (_, __) => const ResourceDetailPage(
              title: 'Configurações',
              subtitle: 'Preferências da empresa, pagamentos e notificações.',
      ...
      ShellRoute(
        builder: (_, __, child) => AppShell(mode: ShellMode.superAdmin, child: child),
        routes: [
          GoRoute(
            path: RoutePaths.superAdmin,
            builder: (_, __) => const ResourceListPage(
              title: 'Visão global da plataforma',
              subtitle: 'Empresas ativas, uso e visão SaaS.',
              endpoint: Endpoints.tenants,
            ),
          ),
          GoRoute(
            path: RoutePaths.superAdminTenants,
            builder: (_, __) => const ResourceListPage(
              title: 'Empresas',
          ...
          GoRoute(
            path: RoutePaths.superAdminPlans,
            builder: (_, __) => const ResourceListPage(
              title: 'Planos SaaS',
              subtitle: 'Planos e limites da plataforma.',
              endpoint: Endpoints.saasPlans,
            ),
          ),
          GoRoute(
            path: RoutePaths.superAdminBilling,
            builder: (_, __) => const ResourceListPage(
              title: 'Cobranças SaaS',
              subtitle: 'Assinaturas e cobranças da plataforma.',
              endpoint: Endpoints.saasBilling,
            ),
          ),
          GoRoute(
            path: RoutePaths.superAdminFlags,
            builder: (_, __) => const ResourceListPage(
              title: 'Feature flags',
              subtitle: 'Liberação de recursos por plano ou empresa.',
              endpoint: Endpoints.featureFlags,
            ),
          ),
          GoRoute(
            path: RoutePaths.superAdminAudit,
            builder: (_, __) => const ResourceListPage(
              title: 'Auditoria',
              subtitle: 'Logs e suporte da plataforma.',
