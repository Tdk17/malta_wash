...
class _CompanyRegisterPageState extends State<CompanyRegisterPage> {
  ...
  Widget build(BuildContext context) {
    return AuthLayout(
      ...
      title: 'Comece com a sua empresa e entre direto no Malta Wash.',
      description:
          'Crie a empresa e a conta do administrador no mesmo fluxo. Depois do cadastro, você entra direto no painel.',
      child: Form(
        key: formKey,
        child: Column(
          ...
          children: [
            ...
            Text(
              'Você será cadastrado como administrador principal.',
            ...
            TextFormField(
              ...
              decoration: const InputDecoration(
                ...
                hintText: 'Ex.: Minha Lavação',
                prefixIcon: Icon(Icons.storefront_outlined),
              ),
              validator: (v) => (v == null || v.trim().length < 3) ? 'Informe o nome da empresa.' : null,
            ),
            ...
            TextFormField(
              ...
              decoration: const InputDecoration(labelText: 'Nome do responsável', prefixIcon: Icon(Icons.person_outline_rounded)),
              validator: (v) => (v == null || v.trim().length < 3) ? 'Informe o nome do responsável.' : null,
            ),
            const SizedBox(height: 14),
            TextFormField(
              controller: phone,
            ...
            TextFormField(
              ...
              decoration: const InputDecoration(labelText: 'E-mail do administrador', hintText: 'admin@suaempresa.com.br', prefixIcon: Icon(Icons.mail_outline_rounded)),
            ...
            TextFormField(
              ...
              decoration: InputDecoration(
                ...
                suffixIcon: IconButton(
                  tooltip: obscureConfirmation ? 'Mostrar confirmação' : 'Ocultar confirmação',
                  ...
                  children: [
                    ...
                    const Expanded(
                      child: Padding(
                        ...
                        child: Text('Aceito os Termos de Uso e a Política de Privacidade da plataforma.', style: TextStyle(fontSize: 12.5, height: 1.4)),
                      ),
                    ),
                  ],
                ),
            ...
            Row(
              children: [
                const Expanded(child: Text('Já cadastrou a empresa?', style: TextStyle(fontWeight: FontWeight.w600))),
                TextButton(
